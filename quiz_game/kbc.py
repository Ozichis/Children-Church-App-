...
questions = ["Who died for our sins?",
             ...
             "How did God make them spread out across the earth?",
             "Who was Abram’s wife?",
             "What was Sarah’s idea for Abram to have a child?"]

first_option = ["Joseph", "Jerusalem",
                "Yes", "Airplane",
                "Joseph", "Martha",
                "Strength", "9", "8th day", "Abraham",
                "Noah", "Build a tower to \nHonour their king",
                "Cast plagues", "Rebecca", "To adopt"]

second_option = ["Peter", "Israel",
                 "No", "Road",
                 "Isaac", "Esther",
                 "Humility", "7", "6th day", "Jacob",
                 "Peter", "Build a tower to reach to Heaven.",
                 "Made a flood",
                 "Mary", "For Abram to have a child with Hagar"]

third_option = ["Jacob", "Tarshish",
                "", "Train",
                "Jacob", "Mary",
                "Victory", "6", "4th day", "Adam",
                "Isaiah", "To build a statue against\nGod",
                "Confused their languages.",
                "Ruth", "To buy a child from one of her slaves"]

fourth_option = ["Jesus", "Judea",
                 "", "Ship",
                 "David", "Sarah",
                 "Sorrow", "5", "1st day", "Moses",
                 "Ham",
                 "Earn money.",
                 "Cast insects", "Sarah",
                 "To get a child from Ninevah"]

correct_answers = ["Jesus", "Tarshish", "Yes", "Ship", "Joseph", "Mary",
                   "Victory", "6", "6th day", "Adam", "Noah", "Build a tower to reach to Heaven.", "Confused their languages.", "Sarah",
    ...
    for i in range(15):
        if value == correct_answers[i]:
            if value == third_option[14]:
                ...
                root2.title('You won 100,000 PTS')
            ...
            amountlabel.config(image=images[i + 1])
